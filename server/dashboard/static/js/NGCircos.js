      ...
      function NGCircosGene(d) {
        return self.GENE[genei].map(function (v, i) {
          ...
          return {
            ...
            link_X1: (0 + Math.sin((v.start) * start_k + d[self.initGenome[v.chr]].startAngle) * (-(self.GENEsettings.outerRadius - self.GENEsettings.innerRadius) / 2 + self.GENEsettings.outerRadius)),
            link_Y1: (0 - Math.cos((v.start) * start_k + d[self.initGenome[v.chr]].startAngle) * (-(self.GENEsettings.outerRadius - self.GENEsettings.innerRadius) / 2 + self.GENEsettings.outerRadius)),
            link_X2: (0 + Math.sin((v.end) * end_k + d[self.initGenome[v.chr]].startAngle) * (-(self.GENEsettings.outerRadius - self.GENEsettings.innerRadius) / 2 + self.GENEsettings.outerRadius)),
            link_Y2: (0 - Math.cos((v.end) * end_k + d[self.initGenome[v.chr]].startAngle) * (-(self.GENEsettings.outerRadius - self.GENEsettings.innerRadius) / 2 + self.GENEsettings.outerRadius)),
            gene_r: (-(self.GENEsettings.outerRadius - self.GENEsettings.innerRadius) / 2 + self.GENEsettings.outerRadius),
            gene_chr: v.chr,
            ...
            cds_outerRadius: self.GENEsettings.outerRadius,
            cds_innerRadius: self.GENEsettings.innerRadius,
            utr_outerRadius: self.GENEsettings.innerRadius + self.GENEsettings.utrWidth,
            utr_innerRadius: self.GENEsettings.outerRadius - self.GENEsettings.utrWidth,
            gene_html: v.html,
          };
        });
      }
      ...
      for (var genei = 0; genei < self.GENE.length; genei++) {
        ...
        if (drawTime == self.GENEsettings.compareGroup) {
              ...
              .attr("d", function (d) {
                ...
                if (self.GENEsettings.compareGroup == 1) {
                  if ((d.endAngle - d.startAngle) >= Math.PI) {
                    if (d.gene_type == "gene" && d.gene_strand == "+") { return "M" + d.link_X1 + "," + d.link_Y1 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 1 1 " + (d.link_X2 - d.link_X1) + "," + (d.link_Y2 - d.link_Y1) + ""; }
                    else if (d.gene_type == "gene" && d.gene_strand == "-") { return "M" + d.link_X2 + "," + d.link_Y2 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 1 0 " + (d.link_X1 - d.link_X2) + "," + (d.link_Y1 - d.link_Y2) + ""; }
                  } else {
                    if (d.gene_type == "gene" && d.gene_strand == "+") { return "M" + d.link_X1 + "," + d.link_Y1 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 0 1 " + (d.link_X2 - d.link_X1) + "," + (d.link_Y2 - d.link_Y1) + ""; }
                    else if (d.gene_type == "gene" && d.gene_strand == "-") { return "M" + d.link_X2 + "," + d.link_Y2 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 0 0 " + (d.link_X1 - d.link_X2) + "," + (d.link_Y1 - d.link_Y2) + ""; }
                  }
                }
                if (self.GENEsettings.compareGroup == 2) {
                  if ((d.endAngle - d.startAngle) >= Math.PI) {
                    ...
                    if (d.gene_type == "gene" && d.gene_strand == "+") { return "M" + d.link_X1 + "," + d.link_Y1 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 0 0 " + (d.link_X2 - d.link_X1) + "," + (d.link_Y2 - d.link_Y1) + ""; }
                    else if (d.gene_type == "gene" && d.gene_strand == "-") { return "M" + d.link_X2 + "," + d.link_Y2 + " " + "a" + d.gene_r + "," + d.gene_r + " 0 0 1 " + (d.link_X1 - d.link_X2) + "," + (d.link_Y1 - d.link_Y2) + ""; }
                  }
                }
              })
              .attr("transform", "translate(" + compareMoveDistance + "," + 0 + ")");
          ...
          if (self.GENEsettings.GENEAnimationDisplay == true) {
            ...
            var cds = d3.svg.arc().innerRadius(self.GENEsettings.outerRadius).outerRadius(self.GENEsettings.innerRadius);
            var utr = d3.svg.arc().innerRadius(self.GENEsettings.outerRadius - self.GENEsettings.utrWidth).outerRadius(self.GENEsettings.innerRadius + self.GENEsettings.utrWidth);
            svg.append("g")
              .attr("class", "NGCircosGENE")
              .selectAll("path.NGCircosGENE")
              .data(gene_objects)
      ...
      if (self.settings.GENEMouseEvent == true) {
        ...
        if (self.settings.GENEMouseOverDisplay == true) {
          GENEMouseOn.on("mouseover", function (d) {
            ...
            if (self.ticksOffset != undefined) {
              GENEMouseOnTooltip.html(function () {
                if (self.settings.GENEMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.HISTOGRAMMouseEvent == true) {
        ...
        if (self.settings.HISTOGRAMMouseOverDisplay == true) {
          HISTOGRAMMouseOn.on("mouseover", function (d) {
            ...
            if (self.ticksOffset != undefined) {
              HISTOGRAMMouseOnTooltip.html(function () {
                if (self.settings.HISTOGRAMMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.LINEMouseEvent == true) {
        ...
        if (self.settings.LINEMouseOverDisplay == true) {
          LINEMouseOn.on("mouseover", function (d) {
            LINEMouseOnTooltip.html(function () {
              if (self.settings.LINEMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.WIGMouseEvent == true) {
        ...
        if (self.settings.WIGMouseOverDisplay == true) {
          WIGMouseOn.on("mouseover", function (d) {
            WIGMouseOnTooltip.html(function () {
              if (self.settings.WIGMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.CNVMouseEvent == true) {
        ...
        if (self.settings.CNVMouseOverDisplay == true) {
          CNVMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              CNVMouseOnTooltip.html(function () {
                if (self.settings.CNVMouseOverTooltipsSetting == "style1") {
    ...
    if (self.HEATMAP.length > 0) {
      ...
      for (var heatmapi = 0; heatmapi < self.HEATMAP.length; heatmapi++) {
        ...
        if (drawTime == self.HEATMAPsettings.compareGroup) {
          ...
          var heatmap = d3.svg.arc().innerRadius(self.HEATMAPsettings.innerRadius).outerRadius(self.HEATMAPsettings.outerRadius);
          ...
          if (self.HEATMAPsettings.HEATMAPAnimationDisplay == true) {
            svg.append("g")
              ...
              .attr("d", function (d, i) {
                if (self.HEATMAPsettings.HEATMAPAnimationDirection == "O2I") { var hm = d3.svg.arc().innerRadius(self.HEATMAPsettings.outerRadius).outerRadius(self.HEATMAPsettings.outerRadius); }
                if (self.HEATMAPsettings.HEATMAPAnimationDirection == "I2O") { var hm = d3.svg.arc().innerRadius(self.HEATMAPsettings.innerRadius).outerRadius(self.HEATMAPsettings.innerRadius); }
                return hm(d, i);
              })
              .transition()
              .delay(function (d, i) {
              ...
              .attr("d", function (d, i) {
                if (d.heatmap_layer == undefined) { return heatmap(d, i); } else {
                  var heatmap2 = d3.svg.arc().innerRadius(self.HEATMAPsettings.innerRadius + (self.HEATMAPsettings.outerRadius - self.HEATMAPsettings.innerRadius) * ((d.heatmap_layer - 1) / self.HEATMAPsettings.totalLayer)).outerRadius(self.HEATMAPsettings.innerRadius + (self.HEATMAPsettings.outerRadius - self.HEATMAPsettings.innerRadius) * (d.heatmap_layer / self.HEATMAPsettings.totalLayer));
                  return heatmap2(d, i)
                }
              })
              .attr("transform", "translate(" + compareMoveDistance + "," + 0 + ")");
            ...
            svg.append("g")
              ...
              .attr("d", function (d, i) {
                console.log(self.HEATMAPsettings.totalLayer); if (d.heatmap_layer == undefined) { return heatmap(d, i); } else {
                  var heatmap2 = d3.svg.arc().innerRadius(self.HEATMAPsettings.innerRadius + (self.HEATMAPsettings.outerRadius - self.HEATMAPsettings.innerRadius) * ((d.heatmap_layer - 1) / self.HEATMAPsettings.totalLayer)).outerRadius(self.HEATMAPsettings.innerRadius + (self.HEATMAPsettings.outerRadius - self.HEATMAPsettings.innerRadius) * (d.heatmap_layer / self.HEATMAPsettings.totalLayer));
                  return heatmap2(d, i)
                }
              })
      ...
      if (self.settings.HEATMAPMouseEvent == true) {
        ...
        if (self.settings.HEATMAPMouseOverDisplay == true) {
          HEATMAPMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              HEATMAPMouseOnTooltip.html(function () {
                if (self.settings.HEATMAPMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.BUBBLEMouseEvent == true) {
        ...
        if (self.settings.BUBBLEMouseOverDisplay == true) {
          BUBBLEMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              BUBBLEMouseOnTooltip.html(function () {
                if (self.settings.BUBBLEMouseOverTooltipsSetting == "style1") {
      ...
      if (self.settings.SCATTERMouseEvent == true) {
        ...
        if (self.settings.SCATTERMouseOverDisplay == true) {
          SCATTERMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              SCATTERMouseOnTooltip.html(function () {
                if (self.settings.SCATTERMouseOverTooltipsSetting == "style1") {
              ...
              if (self.ticksOffset != undefined) {
                ...
                SNPMouseOnTooltip.html(function () {
                  if (self.settings.SNPMouseOverTooltipsSetting == "style1") {
                    ...
                    return "chr : " + d.snp_chr + "<br>pos : " + (parseInt(d.snp_pos)) + "<br># of patients : " + d.snp_val + " <br>AA : " + d.snp_des + ""
                  }
                })
                  .style("left", (d3.event.pageX) + "px")
                  .style("top", (d3.event.pageY + 20) + "px")
        ...
        if (self.CHORDsettings.CHORDAutoFillColor == true) {
          ...
          svg.append("g")
            ...
            .attr("class", function (d) {
              if (fill(d.source.index) == self.settings.CHORDMouseFillColorExcluded && fillStroke(d.source.index) == self.settings.CHORDMouseFillColorExcluded) {
          ...
          if (self.LOLLIPOPsettings.PointType == "circle") {
            if (self.LOLLIPOPsettings.LOLLIPOPAnimationDisplay == false) {
              ...
              svg.append("g")
                ...
                .attr({
                  'stroke': self.LOLLIPOPsettings.LOLLIPOPLineColor,
      ...
      if (self.settings.LOLLIPOPMouseEvent == true) {
        ...
        if (self.settings.LOLLIPOPMouseOverDisplay == true) {
          LOLLIPOPMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              LOLLIPOPMouseOnTooltip.html(function () {
                if (self.settings.LOLLIPOPMouseOverTooltipsSetting == "style1") {
      ...
      function NGCircosARC(d) {
        return self.ARC[arci].map(function (v, i) {
          ...
          return {
            ...
            arc_innerRadius: self.ARCsettings.innerRadius,
            arc_outerRadius: self.ARCsettings.outerRadius,
            arc_html: v.html,
          };
        });
      }
        ...
        if (self.settings.ARCMouseOverDisplay == true) {
          ARCMouseOn.on("mouseover", function (d) {
            if (self.ticksOffset != undefined) {
              ...
              ARCMouseOnTooltip.html(function () {
                if (self.settings.ARCMouseOverTooltipsSetting == "style1") {
                  return "item : " + d.arc_chr + "<br>start : " + (parseInt(d.arc_start)) + "<br>end : " + (parseInt(d.arc_end)) + " <br>des : " + d.arc_des + ""
                } else if (self.settings.ARCMouseOverTooltipsSetting == "custom") {
                  return self.settings.ARCMouseOverTooltipsHtml + d.arc_html
                }
              })
