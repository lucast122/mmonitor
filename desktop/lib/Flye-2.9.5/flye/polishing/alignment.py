...
# import ROOT from build_mmonitor_pyinstaller
from build_mmonitor_pyinstaller import ROOT

logger = logging.getLogger()
MINIMAP_BIN = os.path.join(ROOT, "lib","minimap2","minimap2")
SAMTOOLS_BIN = os.path.join(ROOT, "lib","samtools_mac","samtools")
