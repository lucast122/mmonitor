...
EMU_PRESETS = {
    'silva138': {
        'name': 'SILVA 138.1 SSU',
        'description': 'SILVA 138.1 Small Subunit rRNA database',
        'url': 'https://gitlab.com/treangenlab/emu/-/raw/master/emu-prebuilt/emu-silva.tar.gz',
        'version': '138.1',
        'size_mb': 500,
    },
    'rdp': {
        'name': 'RDP 11.5',
        'description': 'Ribosomal Database Project release 11.5',
        'url': 'https://gitlab.com/treangenlab/emu/-/raw/master/emu-prebuilt/emu-rdp.tar.gz',
        'version': '11.5',
        'size_mb': 200,
    },
    'default': {
        'name': 'EMU Default',
        'description': 'Default EMU database',
        'url': 'https://gitlab.com/treangenlab/emu/-/raw/master/emu-prebuilt/emu.tar.gz',
        'version': '1.0',
        'size_mb': 100,
    }
}
...
CENTRIFUGER_PRESETS = {
    'bacteria': {
        ...
        'description': 'RefSeq complete bacterial genomes',
        'domain': 'bacteria',
        'version': 'latest',
        'size_gb': 50,
    },
    'archaea': {
        ...
        'description': 'RefSeq complete archaeal genomes',
        'domain': 'archaea',
        'version': 'latest',
        'size_gb': 5,
    },
    'viral': {
        ...
        'description': 'RefSeq complete viral genomes',
        'domain': 'viral',
        'version': 'latest',
        'size_gb': 2,
    },
    'fungi': {
        ...
        'description': 'RefSeq fungal genomes',
        'domain': 'fungi',
        'version': 'latest',
        'size_gb': 10,
    },
...
class DatabaseManager:
    ...
    def download_emu_database(self, preset: str, output_dir: Path = None,
        ...
        Args:
            preset: Database preset (silva138, rdp, default)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            archive = Path(tmpdir) / 'emu_db.tar.gz'

            if not self._download_file(info['url'], archive, f"EMU {preset}"):
                return None
